...
export const ar: Record<keyof typeof en, string> = {
  ...
  'overview.signalList.expiredContext': 'انتهت الصلاحية في {date}',
  'overview.signalList.expiredEmpty': 'لا يوجد منتهي الصلاحية',
  'overview.signalList.expiringSoonContext': 'تنتهي الصلاحية في {date}',
  'overview.signalList.expiringSoonEmpty': 'لا يوجد قريب من الانتهاء',
