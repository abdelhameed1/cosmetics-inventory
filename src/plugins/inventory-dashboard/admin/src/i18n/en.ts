export const en = {
  ...
  'overview.signalList.expiredContext': 'expired {date}',
  'overview.signalList.expiredEmpty': 'Nothing expired',
  'overview.signalList.expiringSoonContext': 'expires {date}',
  'overview.signalList.expiringSoonEmpty': 'Nothing expiring soon',
